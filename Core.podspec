...
Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/anugrahdev/Modularization-Core-Module.git"
  ...
  spec.author             = { "Anang Nugraha" => "anangnugraha8@gmail.com" }
  # Or just: spec.author    = "Anang Nugraha"
  # spec.authors            = { "Anang Nugraha" => "anangnugraha8@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Anang Nugraha"
